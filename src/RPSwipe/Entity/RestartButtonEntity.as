package RPSwipe.Entity 
{
	 ...
	 * @author Amidos
	 */
	public class RestartButtonEntity extends ButtonEntity
	{
		
		public function RestartButtonEntity() 
		{
			x = AE.game.width - 5;
			y = 5;
			
			var image:Image = new Image(AE.assetManager.getTexture("restartButton"));
