package RPSwipe.Entity 
{
	 ...
	 * @author Amidos
	 */
	public class GoogleGamesButtonEntity extends ButtonEntity
	{
		
		public function GoogleGamesButtonEntity() 
		{
			x = AE.game.width - 5;
			y = AE.game.height - 5;
			
			var image:Image = new Image(AE.assetManager.getTexture("googleGamesButton"));
